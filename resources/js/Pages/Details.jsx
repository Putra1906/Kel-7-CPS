...
function Detail({ contoh }) {
    ...
    let ardatain = JSON.parse(datain)
    let coba = Object.getOwnPropertyNames(ardatain)
...
export default function Details({ auth }) {
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Rincian Alat</h2>}
        >
            <Head title="Details" />
            ...
            <div className="container">
                <header>
                    <div className="pricing-header p-3 pb-md-4 mx-auto text-center">
                        <h1 className="display-4 fw-normal text-body-emphasis">Rincian Alat</h1>
                        <p className="fs-5 text-body-secondary">Pernagkat IoT "Plant Monitor" terdiri atas komponen-komponen yang membuat pekerjaan memonitor tanaman menjadi lebih mudah.</p>
                        <p className="fs-5 text-body-secondary">Berikut adalah komponen-komponennya</p>
                    </div>
                </header>
